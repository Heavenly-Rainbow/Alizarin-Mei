...
bot.on('/about', function (msg) {
    ...
    let text = 'Bot desarrollado por @HeavenlyRainbow siendo una bifurcación de la funcion "pony pic" de el bot Aika Mei del mismo creador, este bot utiliza node.js como servicio de backend y la api de https://theponyapi.com como fuente.';
